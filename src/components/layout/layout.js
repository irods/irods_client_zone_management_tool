...
export const Layout = ({ children }) => {
  ...
  const { userTotal, groupTotal, rescTotal, zoneContext, specificQueryTotal } =
    useServer();
    ...
    <div>
      ...
      <List>
        ...
        <MenuItem
          ...
          key="zone"
        >
          <ListItemText>Zones ({!zones ? 0 : zones.length})</ListItemText>
        </MenuItem>
        <MenuItem
        ...
        >
          <ListItemText>
            Servers ({!zoneContext ? 0 : zoneContext.length})
          </ListItemText>
        </MenuItem>
        <MenuItem
